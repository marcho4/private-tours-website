            ...
            <div className="w-full max-w-6xl mx-auto">
                ...
                <div className="flex flex-col items-stretch md:flex-row">
                    <div className="grid grid-cols-5 md:grid-cols-2 md:w-2/3 relative">
                        ...
                        <div className="col-span-4 md:col-span-1 font-medium text-balance transition-colors duration-300 text-right text-2xl sm:text-3xl sm:px-5 pt-15">
                            <div className=" break-words hyphens-auto">Лицензия экскурсовода</div>
                            <p className="text-lg font-normal text-right pt-2 break-words">Я получила лицензию экскурсовода в 2023 году</p>
                        </div>
                        
                        <div className="col-span-4 md:col-span-1 font-medium hyphens-auto break-words transition-colors duration-300 text-2xl sm:text-3xl sm:px-5 pt-15">
                            Трехлетний опыт работы
                            <p className="text-lg font-normal pt-2 hyphens-auto break-words">Я работала экскурсоводом в течение 3 лет</p>
                        </div>
                        ...
                        <div className="col-span-4 md:col-span-1 font-medium break-words hyphens-auto transition-colors duration-300 text-right text-2xl sm:text-3xl sm:px-5 pt-15">
                            Повышение квалификации
                            <p className="text-lg font-normal text-right pt-2">Я прошла повышение квалификации в 2024 году</p>
                        </div>
                    </div>
                    <motion.div
